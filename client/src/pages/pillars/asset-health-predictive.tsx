...
export default function AssetHealthPredictive() {
  const pillar = getPillarBySlug("asset-health-predictive");
      ...
      <section className={`py-20 bg-gradient-to-br ${pillar.gradient} text-white`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Ready to Maximize Asset Reliability?
          </h2>
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Contact our team of experts to discuss how our {pillar.shortTitle} solutions can reduce costs and prevent downtime.
          </p>
